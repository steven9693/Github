...
return array(
    ...
    //数据库配置信息
    'DB_TYPE'   => 'mysql', // 数据库类型
    'DB_HOST'   => 'rm-bp1t50g16g02v0458o.mysql.rds.aliyuncs.com', // 服务器地址
    'DB_NAME'   => 'xiaoshuo', // 数据库名
    'DB_USER'   => 'xiaoshuo', // 用户名
    'DB_PWD'    => 'ZsT_1306_eveN', // 密码
    'DB_PORT'   => 3306, // 端口
    'DB_PREFIX' => '', // 数据库表前缀
    'DB_CHARSET'=> 'utf8', // 字符集
...
*/
    ...
    'MODULE_ALLOW_LIST' => array('Home','PC','Mobile','Index','Adminwz'),
