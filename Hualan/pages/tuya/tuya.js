import { getUserInfo, getSystemInfo} from '../../utils/wxApi';
...
Page({
  data: {
    ...
    colorarr: ['#000000', '#666666', '#ff9900', '#ffff00', '#66ff00', '#00ff33', '#00ffcc', '#0099ff', '#0066ff', '#3300ff', '#9900ff', '#ff00cc', '#ff0000', '#cc0000']
  },
  ...
  penSelect: function (e) { //更改画笔大小的方法
    ...
    this.setData({ pen: parseInt(e.currentTarget.dataset.param), penarr: penarr });
    this.isClear = false;
  },
